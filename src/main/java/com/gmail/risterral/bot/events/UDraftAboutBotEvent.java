...
public class UDraftAboutBotEvent implements IBotEvent {
    ...
    public static final String ABOUT_MESSAGE = "Bot was created to allow streamers bigger interaction with viewers while playing draft in Hex. Bot version: 2.2.0. Created by Risterral.";
